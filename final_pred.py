...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model("C:/Users/Tanmay Bhatnagar/OneDrive/Desktop/FRACTAL/Sign Language Project Cont SIH/cnn8grps_rad1_model.h5")
        ...
        self.root = tk.Tk()
        self.root.title("SignX Innovators")
        ...
        self.panel2.config(text="What we captured!", font=("Courier", 30, "bold"))

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=5)
        self.T.config(text="SignX Innovators Sign to Text", font=("Courier", 30, "bold"))
